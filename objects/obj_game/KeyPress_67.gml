if (global.debug){
	...
	ini_write_real("achieves", "death_joetube", 1)
	ini_write_real("achieves", "death_dj", 1)
	ini_write_real("achieves", "death_jesse", 1)
	ini_write_real("achieves", "death_lydia", 1)
	ini_write_real("achieves", "death_a90", 1)
	ini_write_real("achieves", "complete_attic", 1)
	ini_write_real("achieves", "complete_wheatfield", 1)
	ini_write_real("achieves", "complete_stronghold", 1)
	ini_write_real("achieves", "complete_storage", 1)
	ini_write_real("achieves", "complete_hotel", 1)
	ini_write_real("achieves", "complete_forest", 1)
	ini_write_real("achieves", "complete_game", 1)
	ini_write_real("achieves", "complete_fast", 1)
	ini_write_real("achieves", "complete_hard", 1)
	ini_write_real("achieves", "complete_hardfast", 1)
	ini_write_real("achieves", "complete_endless", 1)
	ini_write_real("achieves", "complete_somemods", 1)
	ini_write_real("achieves", "complete_allmods", 1)
